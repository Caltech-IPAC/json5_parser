...
struct Test_runner {
    ...
    void check_stream_reader(Stream_reader<Istream_type, Value_type>& reader,
    ...
    void check_stream_read_or_throw(
            Stream_reader_thrower<Istream_type, Value_type>& reader,
            const vector<int>& expected_result) {
        Value_type v;
