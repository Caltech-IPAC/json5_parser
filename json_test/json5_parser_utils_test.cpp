...
struct Test_runner {
    ...
    void check_find(const Obj_t& obj, const char* name,
                    const Value_type& expected_result) {
    ...
    void test_find() {
        ...
        const Obj_t obj_2 =
                list_of(Pair_type(to_str("a"), 1))(Pair_type(to_str("ab"), 2));

        check_find(obj_2, "a", 1);
        check_find(obj_2, "ab", 2);

        const Obj_t obj_3 = list_of(Pair_type(to_str("a"), 1))(
                Pair_type(to_str("ab"), 2))(Pair_type(to_str("abc"), 3));
