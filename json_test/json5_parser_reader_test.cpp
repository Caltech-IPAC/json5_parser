...
struct Test_runner {
    ...
    void test_reading_reals() {
        ...
        const String_type in_s = to_str(
                "[1.200000000000000,1.234567890123456e+125,-1.234000000000000e-123,"
    ...
    void test_escape_chars() {
        ...
        test_escape_chars(
                "\\x01\\x02\\x7F",
                "\x01\x02\x7F");  // NB x7F is the greatest char spirit will parse
    ...
    void check_read_fails(const char* c_str, int line, int column,
                          const string& reason) {
        Value_type value;
    ...
    void check_value_sequence(Iter_type first, Iter_type last,
                              const Ints& expected_values, bool all_input_consumed) {
        Value_type value;
    ...
    void check_value_sequence(Istream_type& is, const Ints& expected_values,
                              bool all_input_consumed) {
        Value_type value;
    ...
    void check_value_sequence(const char* c_str, const Ints& expected_values,
                              bool all_input_consumed) {
    ...
    void check_array(const Value_type& value,
                     typename Array_type::size_type expected_size) {
        assert_eq(value.type(), array_type);
    ...
    void check_reading_array(Iter_type& begin, Iter_type end,
                             typename Array_type::size_type expected_size) {
        Value_type value;
    ...
    void check_reading_array(Istream_type& is,
                             typename Array_type::size_type expected_size) {
        Value_type value;
