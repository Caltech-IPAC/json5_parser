...
bool operator==(const Address& a1, const Address& a2) {
    return (a1.house_number_ == a2.house_number_) && (a1.road_ == a2.road_) &&
           (a1.town_ == a2.town_) && (a1.county_ == a2.county_) &&
...
void write_addrs(const char* file_name, const Address addrs[]) {
    ...
    write_stream(Value(addr_array), os,
                 pretty_print);  // NB need to convert Array to a Value
