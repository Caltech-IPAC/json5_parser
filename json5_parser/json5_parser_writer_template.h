...
private:
    ...
    Generator& operator=(const Generator&);  // to prevent "assignment operator could
                                             // not be generated" warning
    ...
    boost::io::basic_ios_all_saver<Char_type> ios_saver_;  // so that ostream state is
                                                           // reset after control is
